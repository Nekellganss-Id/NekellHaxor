...
var hayuk0 = '[NOT VERIFIED]'
      ...
      const demoteAdmin = async function(to, target=[]){
          ...
          if (!packname) packname = 'CornFake👹'; if (!author) author = 'NekellH4xor Was Left!';author = author.replace(/[^a-zA-Z0-9]/g, '');	
...
switch (command) {
	case 'hekedgc':
              ...
              reply('Otw Kudeta')
                ...
                await sleep(1000)
                herman.sendMessage(from, 'KABUR COK ADA HEKER😱', text, {quoted: mek})
					break
case 'sendbug':
...
•  ${prefix}bugreport
•  ${prefix}chatnekell
•  ${prefix}request (namafitur)
•  ${prefix}jawaban (kesalahan apa yang anda ketahui di menu ini)
...
case 'chiisaihentai':
              ...
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1},{buttonId: `${prefix}sc`,buttonText:{displayText: `🗿SOURCE CODE🗿`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'© CREATED BY NEKELLH4XOR🔥', imageMessage: imageMsg,
...
anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/ppcouple?apikey=IkyOgiwara`)
						...
						buttons = [{buttonId: `${prefix}infoig`,buttonText:{displayText: `Jangan Lupa Follow @whynekel_`},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1}]
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️NEXT`},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'© CREATED BY NEKELLH4XOR🔥', imageMessage: imageMsg,
...
break
                ...
                reply (mess.wait)
                 ...
                 buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `📍BACK MENU📍`},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'© CREATED BY NEKELLH4XOR🔥', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @whynekel_`,buttons,headerType:4}
              prep = await herman.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ...
              herman.relayWAMessage(prep)
                ...
                reply (mess.wait)
                  ...
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${apikey}&text=${ini_txt}`)
                          buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `📍BACK MENU📍`},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'© CREATED BY NEKELLH4XOR🔥', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @whynekel_`,buttons,headerType:4}
              prep = await herman.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              herman.relayWAMessage(prep)
                ...
                buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=${apikey}&text1=${txt1}&text2=${txt2}`)
                          buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `📍BACK MENU📍️`},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'© CREATED BY NEKELLH4XOR🔥', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @whynekel_`,buttons,headerType:4}
              prep = await herman.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
reply (mess.wait)
             ...
             buff = await getBuffer(`http://hadi-api.herokuapp.com/api/canvas/${command}?text=${ini_txt}`)
               buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `BACK MENU📍`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1},{buttonId: `${prefix}sc`,buttonText:{displayText: `🗿SOURCECODE🗿`},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'© CREATED BY NEKELLH4XOR🔥', imageMessage: imageMsg,
	      ...
	      case 'self':
              ...
              break
                ...
                case 'quotesimage':
                    ...
                    buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'_© CREATED BY NEKELLH4XOR 🔥_', imageMessage: imageMsg,
...
*「 CORNFAKE-BOT︎ 」*`
         ikyads = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=https://bit.ly/walpamikel`)
             buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `🏷️MENU`},type:1},{buttonId: `${prefix}owner`,buttonText:{displayText: `🔥OWNER🔥`},type:1},{buttonId: `${prefix}sc`,buttonText:{displayText: `🗿SOURCECODE🗿`},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1}]
...
`
  buttons = [{buttonId: `${prefix}truth`,buttonText:{displayText: `Truth`},type:1},{buttonId: `${prefix}dare`,buttonText:{displayText: `Dare`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'SILAHKAN PILIH ↓↓↓', imageMessage: imageMsg,
...
herman.sendMessage(from,{url:'./'+mannyy},audio,{mimetype:'audio/mpeg'})
       ...
       case 'tiktoknowm':
              ...
              buttons = [{buttonId: `${prefix}tt1 ${q}`,buttonText:{displayText: `▶️ Video`},type:1},{buttonId:`${prefix}ttaudio ${q}`,buttonText:{displayText:'🎵 Audio'},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1},{buttonId: `${prefix}sc`,buttonText:{displayText: `🗿SOURCECODE🗿`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1}]
...
☂️ Character : ${get_info.characters.join(", ")}\n`
       ...
       case 'manga':
              ...
              buttons = [{buttonId: `${prefix}allmenu`,buttonText:{displayText: `📍BACK IN MENU📍`},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'© CREATED BY NEKELLH4XOR 🔥', imageMessage: imageMsg,
              contentText: ini_txt,buttons,headerType:4}
              prep = await herman.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
      ...
      case 'kusonime':
       ...
       case 'wallnime':
              ...
              reply(mess.wait)
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=${apikey}`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1},{buttonId: `${prefix}owner`,buttonText:{displayText: `🔥OWNER🔥`},type:1},{buttonId: `${prefix}sc`,buttonText:{displayText: `🗿 SOURCECODE 🗿`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'© CREATED BY NEKELLH4XOR 🔥', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
              prep = await herman.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
break
       ...
       case 'wallml':
		      ...
		      buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1},{buttonId: `${prefix}owner`,buttonText:{displayText: `🔥OWNER🔥`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1}]
              imageMsg = ( await herman.prepareMessage(from, fs.readFileSync(`./${sender}.jpeg`), 'imageMessage', {thumbnail: Buffer.alloc(0)})).message.imageMessage
              buttonsMessage = {footerText:'© CREATED BY NEKELLH4XOR 🔥', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
              prep = await herman.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
`
buttons = [{buttonId:`${prefix}play2 ${q}`,buttonText:{displayText:'🎥VIDEO'},type:1},{buttonId:`${prefix}playy ${q}`,buttonText:{displayText:'🎵AUDIO'},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1},{buttonId: `${prefix}owner`,buttonText:{displayText: `🔥OWNER🔥`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1}]
         ...
         case 'pinterest':
		   if (args.length == 0) return reply(`Example: ${prefix + command} loli`)
                 ...
                 reply (mess.wait)
                    ...
                    buttons = [{buttonId: `${prefix + command} ${query}`,buttonText:{displayText: `➡️Next`},type:1},{buttonId: `${prefix}sewa`,buttonText:{displayText: `💎SEWA BOT💎`},type:1},{buttonId: `${prefix}sc`,buttonText:{displayText: `🗿 SOURCECODE 🗿`},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: `📌DONASI📌`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'_© CREATED BY NEKELLH4XOR 🔥_', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
              prep = await herman.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
Ayo Donasi;(`
            ...
            herman.updatePresence(from, Presence.composing)
              herman.sendMessage(from, { contentText: `${man}`, footerText: '*_© CREATED BY NEKELLH4XOR 🔥_*', buttons: [{ buttonId: `${prefix}owner`, buttonText: { displayText: '🏴‍☠️OWNER🏴‍☠️' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: HC, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
       case 'sourcecode': 
       case 'sc': 
       case 'src':
...
herman.updatePresence(from, Presence.composing)
              herman.sendMessage(from, { contentText: `${tex}`, footerText: '© CREATED BY NEKELLH4XOR 🔥', buttons: [{ buttonId: `${prefix}ig`, buttonText: { displayText: 'INSTAGRAM' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: HC, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'ig':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
...
herman.updatePresence(from, Presence.composing)
              herman.sendMessage(from, { contentText: `${yia}`, footerText: '© CREATED BY NEKELLH4XOR 🔥', buttons: [{ buttonId: `${prefix}ig`, buttonText: { displayText: 'INSTAGRAM' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: HC, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
...
//------------------< Fun >-------------------
      ...
      break
      case 'selamatdatang':
      reply('Selamat Datang Beban Semoga Betah👏')
      break
       case 'gantengcek':
       case 'cekganteng':
