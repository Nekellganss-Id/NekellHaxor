...
${mn} *Versi* : *${os.platform()}*`
			...
			herman.updatePresence(from, Presence.composing)
                    ...
                    herman.sendMessage(from, { contentText: `${menu}`, footerText: 'Jika Kamu Menggunakan Whatsaap Mod Dan Tidak Ada Button Atau Button Tidak Respon Langsung Ketik !allmenu Saja\n• Note!! Dilarang Menyepam Bot Beri Jeda Minimal 3-5detik! Please Hargai Owner \n© CREATED BY NEKELLH4XOR 🔥', buttons: [{ buttonId: `${prefix}allmenu`, buttonText: { displayText: 'ALLMENU' }, type: 1 },{ buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: Herman, contextInfo: {mentionedJid: [sender, owner]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 lol = {
...
Tqto : All Friend And All Idoll!`
              ...
              herman.updatePresence(from, Presence.composing)
              herman.sendMessage(from, { contentText: `${menu}`, footerText: '• Jangan Lupa Donasi Ya..😊', buttons: [{ buttonId: `!sewa`, buttonText: { displayText: '乡SEWA BOT' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: Herman2, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
...
case 'fitnah':
        ...
        case 'wasted':
		      ...
		      buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Follow @whynekel_`},type:1}]
              ...
              herman.relayWAMessage(prep)
                ...
                reply (mess.wait)
                 ...
                 buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=${apikey}&text1=${txt1}&text2=${txt2}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `🏴‍☠️BACK MENU🏴‍☠️`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'© CREATED BY NEKELLH4XOR🔥', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @whynekel_`,buttons,headerType:4}
              prep = await herman.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
	      ...
	      case 'self':
              ...
              break
                ...
                case 'quotesimage':
                    ...
                    buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'CORNFAKEBOT', imageMessage: imageMsg,
...
- PULSA`
  herman.updatePresence(from, Presence.composing)
              herman.sendMessage(from, { contentText: `${text}`, footerText: 'Monggo Di Beli Biar\nBisa Nikmatin Fitur Lainnya', buttons: [{ buttonId: `!owner`, buttonText: { displayText: '乡OWNER🤖' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: HC, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
...
☂️ Character : ${get_info.characters.join(", ")}\n`
       ...
       case 'manga':
              ...
              imageMsg = (await herman.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'CORN BOT', imageMessage: imageMsg,
              contentText: ini_txt,buttons,headerType:4}
              prep = await herman.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              herman.relayWAMessage(prep)
         break
...
case 'play2':   
                ...
                reply('Loading.... ')
				play = args.join(" ")
				anu = await fetchJson(`https://api.lolhuman.xyz/api/ytplay2?apikey=${apikey}&query=${query}`)
...
//------------------< Sticker/Tools >-------------------
      ...
      case 'doge':
       ...
       case 'telestiker':
              ...
              reply(mess.wait)
              ini_url = await fetchJson(`https://api.lolhuman.xyz/api/telestick?apikey=${apikey}&url=${args[0]}`)
...
woy = args.join(" ")
reply('wait....')
anjay = `https://api.lolhuman.xyz/api/${command}?apikey=${apikey}&text=${text}`
...
Ayo Donasi;(`
            ...
            herman.updatePresence(from, Presence.composing)
              herman.sendMessage(from, { contentText: `${man}`, footerText: '© CREATED BY NEKELLH4XOR 🔥', buttons: [{ buttonId: `!owner`, buttonText: { displayText: 'OWNER' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: HC, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
       case 'sourcecode': 
       case 'sc': 
       case 'src':
...
herman.updatePresence(from, Presence.composing)
              herman.sendMessage(from, { contentText: `${tex}`, footerText: '© CREATED BY NEKELLH4XOR 🔥', buttons: [{ buttonId: `!ig`, buttonText: { displayText: 'INSTAGRAM' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: HC, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'ig':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
...
herman.updatePresence(from, Presence.composing)
              herman.sendMessage(from, { contentText: `${yia}`, footerText: '© CREATED BY NEKELLH4XOR 🔥', buttons: [{ buttonId: `!ig`, buttonText: { displayText: 'INSTAGRAM' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: HC, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
