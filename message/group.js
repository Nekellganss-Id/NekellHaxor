...
module.exports = welcome = async (herman, anu) => {
		...
		try {
            ...
            buff = await getBuffer(`https://api.lolhuman.xyz/api/base/welcome?apikey=${apikey}&img1=${pp_user}&img2=${pp_grup}&background=https://i.ibb.co/8B6Q84n/LTqHsfYS.jpg&username=${encodeURI(anu_user)}&member=${memeg}&groupname=${encodeURI(mdata.subject)}`)
        buttons = [

          { buttonId: `!selamatdatang`, buttonText: { displayText: "Welcome Beban👋" }, type: 1 },
        ...
        buttonsMessage = {
          ...
          footerText: "Welcome Message By Nekell H4xor",
      ...
      if (anu.action == "remove" && !mem.includes(herman.user.jid)) {
        ...
        buttons = [
          ...
          { buttonId: `!bay`, buttonText: { displayText: "Sayonara Bebann👋" }, type: 1 },];
        ...
        buttonsMessage = {
          ...
          footerText: "Leave Message By Nekell H4xor",
